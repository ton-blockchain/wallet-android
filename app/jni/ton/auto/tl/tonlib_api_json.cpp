...
Status from_json(tonlib_api::accountList &to, JsonObject &from) {
  {
    ...
    if (value.type() != JsonValue::Type::Null) {
      TRY_STATUS(from_json(to.accounts_, value));
    }
  }
  return Status::OK();
}
...
Status from_json(tonlib_api::options_configInfo &to, JsonObject &from) {
  ...
  }
  {
    ...
    if (value.type() != JsonValue::Type::Null) {
      TRY_STATUS(from_json(to.default_rwallet_init_public_key_, value));
    }
  }
  return Status::OK();
}
...
Status from_json(tonlib_api::guessAccount &to, JsonObject &from) {
  ...
  }
  {
    ...
    if (value.type() != JsonValue::Type::Null) {
      TRY_STATUS(from_json(to.rwallet_init_public_key_, value));
    }
  }
  return Status::OK();
}
...
void to_json(JsonValueScope &jv, const tonlib_api::accountList &object) {
  auto jo = jv.enter_object();
  jo << ctie("@type", "accountList");
  jo << ctie("accounts", ToJson(object.accounts_));
}
...
void to_json(JsonValueScope &jv, const tonlib_api::options_configInfo &object) {
  ...
  jo << ctie("default_rwallet_init_public_key", ToJson(object.default_rwallet_init_public_key_));
}
...
void to_json(JsonValueScope &jv, const tonlib_api::guessAccount &object) {
  auto jo = jv.enter_object();
  jo << ctie("@type", "guessAccount");
  jo << ctie("public_key", ToJson(object.public_key_));
  jo << ctie("rwallet_init_public_key", ToJson(object.rwallet_init_public_key_));
}
